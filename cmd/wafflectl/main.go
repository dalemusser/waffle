...
func usage() {
	fmt.Println("WAFFLE CLI (wafflectl)")
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  wafflectl new <appname> --module <module-path>")
	fmt.Println()
	fmt.Println("Example:")
	fmt.Println("  wafflectl new strata_hub --module github.com/dalemusser/strata_hub")
}
...
func newCmd(args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: wafflectl new <appname> --module <module-path>")
		fs.PrintDefaults()
	}
